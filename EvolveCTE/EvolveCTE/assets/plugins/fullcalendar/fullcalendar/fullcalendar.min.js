...
(function(t, e) {
    ...
    function Z(e, n, r) {
        ...
        function h(t) {
           ...
           /* return t.getMonth() != n && o.push("fc-other-month"), +t == +r ? o.push("fc-today", le + "-state-highlight") : r > t ? o.push("fc-past") : o.push("fc-future"), a += "<td class='" + o.join(" ") + "'" + " data-date='" + xe(t, "yyyy-MM-dd") + "'" + ">" + "<div>", re && (a += "<div class='fc-day-number'>" + t.getDate() + "<div class='checkbox'><input type='checkbox' class='i-grey-square' checked='true'></div>" + "</div>"), a += "<div class='h2 inline-popups'><button class='btn btn-success' data-toggle='modal' data-target='#DefaultModal'>+</button></div>" + "</div></div></td>"*/
		   
		    return t.getMonth() != n && o.push("fc-other-month"), +t == +r ? o.push("fc-today", le + "-state-highlight") : r > t ? o.push("fc-past") : o.push("fc-future"), a += "<td class='" + o.join(" ") + "'" + " data-date='" + xe(t, "yyyy-MM-dd") + "'" + ">" + "<div>", re && (a += "<div class='fc-day-number'>" + t.getDate() + "<div class='checkbox'><input type='checkbox' class='i-grey-square' checked='true'></div>" + "<div class='h2 inline-popups'><button class='btn btn-success' data-toggle='modal' data-target='#DefaultModal'>+</button></div>" + "</div>"), a +=  "</div></div></td>"
