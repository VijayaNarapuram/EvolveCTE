$(document).ready(function(){
	...
	//if ($('#datatable-assignments-list').length > 0) {
	//    $('#datatable-assignments-list').dataTable();
	//}


	if ($('#datatable-attendance-view').length > 0) {
	    $('#datatable-attendance-view').dataTable();
	}

	if ($('#datatable-course-list').length > 0) {
	    $('#datatable-course-list').dataTable();
	}

	if ($('#datatable-gradebook-1').length > 0) {
	    $('#datatable-gradebook-1').dataTable();
	}

	if ($('#datatable-gradebook-2').length > 0) {
	    $('#datatable-gradebook-2').dataTable();
	}

	if ($('#datatable-gradebook-3').length > 0) {
	    $('#datatable-gradebook-3').dataTable();
	}

	if ($('#datatable-notes').length > 0) {
	    $('#datatable-notes').dataTable();
	}

	if ($('#datatable-activities1').length > 0) {
	    $('#datatable-activities1').dataTable();
	}
	...
	if ($('.datepicker').length > 0){
	    ...
	    // $('.datepicker').prop("readonly", true);/* By Vishnu: to make all time pickers to readonly to avoid key board entries in this textbox */
	...
	if ($('.timepicker').length > 0){
	   ...
	   // $('.timepicker').prop("readonly", true); /* By Vishnu: to make all time pickers to readonly to avoid key board entries in this textbox */
	}
	/** END TIMEPICKER **/
	...
	$(function () {
		...
		$('.zip_us_masking').mask('00000');
		$('.age_masking').mask('00');
		$('.sixdigit_masking').mask('000000');
